package rhymestudio.rhyme.client.render.post.effect;
...
import rhymestudio.rhyme.client.render.post.DIYBlitTarget;
import rhymestudio.rhyme.client.render.post.PostEffect;
import rhymestudio.rhyme.core.registry.items.MaterialItems;

import java.util.HashMap;
import java.util.Map;

import static rhymestudio.rhyme.client.render.post.PostUtil.postPass;
